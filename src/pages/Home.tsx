    ...
    <div className="home-new theme-light">
      ...
      <div className="hero-section">
        <div className="hero-content">
          <h1 className="hero-title">🏝️ Explore Salvador do seu jeito</h1>
          ...
          <div className="options-grid">
            <div className="option-card featured" onClick={() => navigate('/planejar-viagem')}>
              ...
              <div className="option-features">
                <span className="feature-tag">✓ Multi-dias</span>
                <span className="feature-tag">✓ Personalizado</span>
                <span className="feature-tag">✓ Completo</span>
              </div>
            ...
            <div className="option-card" onClick={() => navigate('/questionario')}>
              ...
              <div className="option-features">
                <span className="feature-tag">✓ 1-4 horas</span>
                <span className="feature-tag">✓ Rápido</span>
              </div>
            ...
            <div className="option-card" onClick={() => navigate('/bate-e-volta')}>
              ...
              <div className="option-features">
                <span className="feature-tag">✓ Praias</span>
                <span className="feature-tag">✓ Ilhas</span>
              </div>
              <button className="btn-bahia-secondary option-btn">
                Ver Destinos
              </button>
